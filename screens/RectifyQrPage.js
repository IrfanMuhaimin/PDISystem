...
const localStyles = StyleSheet.create({
    ...
    // QR Code Box and Camera
    qrBox: {
        width: 280, // Fixed size for QR box/camera view
        height: 280,
        borderWidth: 2,
        borderColor: COLORS.grey, // Grey border
        alignItems: 'center',
        justifyContent: 'center',
        marginVertical: MARGIN.small,
        overflow: 'hidden', // Clip CameraView inside
        position: 'relative', // For absolute positioning of close button
        backgroundColor: COLORS.white, // Background for placeholder
    },
    closeButton: { // Button to close the camera view
        position: 'absolute',
        bottom: 10,
        alignSelf: 'center',
