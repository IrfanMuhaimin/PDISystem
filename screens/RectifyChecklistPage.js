...
export default function RectifyChecklistPage({ navigation, route }) {
    ...
    const handleModalConfirm = (name, no, remark, date, closed) => {
        ...
        rectifyItemWithDetails(itemId, { name, no, remark, date, closed });
        handleModalClose();
    };
                ...
                >
                    <View style={localStyles.modalContainer}>
                        ...
                        <Text style={localStyles.modalSubHeader}>
                            {`Image ${currentImageIndex + 1} of ${images.length}${currentImageData.description
                        ...
                        <View style={localStyles.imageContainer}>
                            <Image
                                ...
                                onError={(e) => {
                                    ...
                                    Alert.alert(
                                        "Image Error",
                                        `Failed to load image: ${currentImageData.description || imageUrl
